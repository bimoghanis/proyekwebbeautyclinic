...
import facilityRoom from "../assets/facilityRoom.webp";
import treatmentRoom from "../assets/treatmentRoom.webp";
import tools1 from "../assets/tools1.webp";
import tools2 from "../assets/tools2.webp";
      ...
      <section className="w-full bg-white flex flex-col justify-center px-6 py-24 relative">
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-7xl mx-auto">
            {/* Main Facility */}
            <div className="h-[400px] md:h-[600px] w-full overflow-hidden rounded-[2rem] relative group shadow-lg bg-gray-100 border border-gray-100">
              <img
                src={facilityRoom}
                alt="Aldiora Main Facility"
            ...
            <div className="grid grid-rows-2 gap-6 h-[400px] md:h-[600px]">
              {/* Treatment Room */}
              <div className="rounded-[2rem] overflow-hidden h-full relative group shadow-lg bg-gray-100 border border-gray-100">
                <img
                  src={treatmentRoom}
                  alt="Treatment Room"
                  className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              ...
              <div className="grid grid-cols-2 gap-6 h-full">
                <div className="rounded-[2rem] overflow-hidden relative group shadow-lg bg-gray-100 border border-gray-100">
                  <img
                    src={tools1}
                    alt="Clinic Tool 1"
                    className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-5xl">
          <div className="space-y-10 text-center flex flex-col items-center">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full mt-8">
              {/* Lokasi */}
              <div className="flex flex-col items-center text-center p-8 bg-white/5 rounded-[2rem] border border-white/5 hover:bg-white/10 transition-all duration-300">
