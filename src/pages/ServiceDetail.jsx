  ...
  if (!service) {
    return (
      <div className="h-screen flex flex-col items-center justify-center bg-[#E5F0EB]">
        <h1 className="text-2xl font-bold text-[#15503E]">
          Treatment Not Found
        </h1>
        <Link to="/konsultasi" className="mt-4 text-blue-600 hover:underline">
          Back to Menu
        </Link>
      </div>
    );
      ...
      <div className="container mx-auto px-6 py-24 md:py-32 max-w-5xl">
        ...
        {service.pricing && service.pricing.length > 0 && (
          <div className="bg-transparent space-y-2">
            <h3 className="text-xl font-bold uppercase tracking-widest mb-6 opacity-60">
              Price List
            </h3>
